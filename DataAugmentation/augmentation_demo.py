...
# construct the aegument pare and parse the arguments
...
# load the input uimage , convert it to a numpy array, and
# then reshape it to have an extra dimension
...
for image in imageGen:
    ...
    # if we have reached 10 examples., break break the loop
    if total == 10:
        break
